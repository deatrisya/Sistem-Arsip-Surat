            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Kategori Surat</h5>
                            <form action="{{ route('kategori.store') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="keterangan" placeholder="Masukkan keterangan kategori" rows=3 required></textarea>
                                    @error('keterangan')
